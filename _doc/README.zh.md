...
参考文档：[using jekyll with pages](https://help.github.com/articles/using-jekyll-with-pages/) & [Upgrading from 2.x to 3.x](//jekyllrb.com/docs/upgrading/2-to-3/)
...
**[在这里预览模板 &rarr;](//huangxuan.me/huxblog-boilerplate/)**
