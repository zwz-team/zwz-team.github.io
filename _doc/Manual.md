...
This theme uses the default code syntax highlighter of jekyll, [Rouge](//rouge.jneen.net/), which is compatible with Pygments theme so just pick any pygments theme css (e.g. from [here](//jwarby.github.io/jekyll-pygments-themes/languages/javascript.html) and replace the content of `highlight.less`.
...
For more options, please check out [Jekyll - Official Site](//jekyllrb.com/). 
...
Modules *[Featured Tags](#featured-tags)*, *[Mini About Me](#mini-about-me)* and *[Friends](#friends)* are turned on by default and you can add your own. The sidebar is naturally responsive, i.e. be pushed to bottom in a smaller screen (`<= 992px`, according to [Bootstarp Grid System](//getbootstrap.com/css/#grid))  
...
**Featured-Tags** is similar to any cool tag features in website like [Medium](//medium.com).
...
Currently, [Disqus](//disqus.com) <del> and [Duoshuo](//duoshuo.com)</del> are supported as third party discussion system.
...
- **[Comment](#comment)** support [**Disqus**](//disqus.com) officially, thanks to @rpsh.
...
- Support **PingFang (苹方)**, the new Chinese font presented by [OS X El Capitan](//www.apple.com/cn/osx/whats-new/)


#### V1.3

- Big Improvement to the **Navigation Menu** *(especially in Android)*:  Dropping the old, stuttering, low-performance [Bootstrap collapse.js](//getbootstrap.com/javascript/#collapse),  replaced with an own wrote, [jank free](//jankfree.org/) navbar menu in a pretty high-performance implementation of [Google Material Design](https://www.google.com/design/spec/material-design/introduction.html).

<img src="//huangxuan.me/img/blog-md-navbar.gif" width="320" />
...
- Using [DuoShuo](//duoshuo.com/) as the Disqus-like third party discussion system
