...
![Unix_timeline](//upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Unix_timeline.en.svg/800px-Unix_timeline.en.svg.png)


#### Linux Kernel

严格来讲，术语 Linux 只表示 [Linux Kernel](//en.wikipedia.org/wiki/Linux_kernel) 操作系统内核本身，比如说 Android is Based on Linux (Kernel). Linus 编写的也只是这一部分，一个免费的 Unix-like Kernel，并不属于 GNU Project 的一部分。
...
* [Mozilla Public License](//en.wikipedia.org/wiki/Mozilla_Public_License)
* [MIT License](//en.wikipedia.org/wiki/MIT_License)
* [BSD Public License](//en.wikipedia.org/wiki/BSD_licenses)
	* GPL 强制后续版本必须是自由软件，而 BSD 的后续可以选择继续开源或者封闭
* [Apache License](//en.wikipedia.org/wiki/Apache_License)

![Public License](//dl2.iteye.com/upload/attachment/0047/4142/d770c85a-49b7-3c7f-8ae2-cbb6451e00d8.png)
...
所以在 wiki 里是没有 Android ROM 这个词条的，只有 [List of custom Android firmwares](//en.wikipedia.org/wiki/List_of_custom_Android_firmwares)
...
For Detail, Chromium OS based on [Gentoo Linux](//en.wikipedia.org/wiki/Gentoo_Linux), emm...
